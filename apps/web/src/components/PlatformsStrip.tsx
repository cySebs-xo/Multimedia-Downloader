const PLATFORMS = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" width="36" height="36" fill="currentColor">
        <path d="M17.618 10.155l-1.921-1.111.961-.555a3.844 3.844 0 0 0-1.921-6.938A3.84 3.84 0 0 0 11.233 4.25L5.753 7.421A3.84 3.84 0 0 0 3.832 10.74a3.843 3.843 0 0 0 1.92 3.328l1.921 1.112-.961.555a3.843 3.843 0 0 0 1.921 6.938c1.552 0 2.947-.93 3.56-2.355l5.48-3.171a3.842 3.842 0 0 0 1.945-3.328 3.843 3.843 0 0 0-1.92-3.328zM10.25 14.5v-5l4.33 2.5-4.33 2.5z"/>
      </svg>
    ),
  },
  {
