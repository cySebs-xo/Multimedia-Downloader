  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" height="36" width="36" fill="currentColor">
        <path d="m19 1 -4.5 1.5v6.372C13.283 7.704 11.713 7 10 7c-3.866 0 -7 3.582 -7 8s3.134 8 7 8c1.713 0 3.283 -0.704 4.5 -1.872V23H19V1Zm-8 17.5a3.5 3.5 0 1 0 0 -7 3.5 3.5 0 0 0 0 7Z"/>
      </svg>
    ),
  },
  {
